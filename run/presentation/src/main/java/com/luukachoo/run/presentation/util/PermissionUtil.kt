package com.luukachoo.run.presentation.util
...
fun Context.hasNotificationPermission(): Boolean = if (Build.VERSION.SDK_INT >= 33 ) hasPermission(Manifest.permission.POST_NOTIFICATIONS) else true